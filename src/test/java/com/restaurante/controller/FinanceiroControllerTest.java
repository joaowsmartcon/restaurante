...
//		Financeiro financeiro = new Financeiro(1L, new EmpresaPessoa(), new Date(), new Date(), new Date(), BigDecimal.TEN, BigDecimal.TEN
...
//	}
	...
	public void saveShouldReturnStatusError() throws Exception {
	    ...
	    public void findByIdShouldReturnStatusError() throws Exception {
	        mockMvc.perform(get("/financeiro/find")
	        		.queryParam("id", "null"))
	                .andExpect(status().isBadRequest());
	    }
	    ...
	    public void deleteShouldReturnStatusError() throws Exception {
	        mockMvc.perform(delete("/financeiro/delete")
	        		.queryParam("id", "null"))
	                .andExpect(status().isBadRequest());
	    }
